...
tbodyEl.addEventListener("click", (e)=>{
    ...
    const id = tr.id;
    if (e.target.dataset.action === "delete") deleteStudent(id).then(()=>getStudents()).then((res)=>renderStudents(res));
...
addStudentsEl.addEventListener("click", (e)=>{
    ...
    console.log(data);
    addStudent(data).then(getStudents).then((res)=>renderStudents(res)).finally(()=>{
        addStudentFormEl.reset();
    });
// addStudent(data)
//   .then(getStudents())
